---
layout: post
title: Heart_Disease Prediction
...
Next, I proceeded to test eight different machine learning models as part of the predictive modeling process. These models included:
...
I will build a model that looks to accurately predict *heart_disease*, based upon the patients metrics listed above. I tested eight different machine learning models. These models included:
...
<br>
![alt text](/img/posts/distribution of the age group of patients whether they have a heart disease or not.png "Age distribution based on the categories of target")
